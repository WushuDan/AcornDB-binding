...
impl Trunk<Vec<u8>> for DataLakeTrunk {
...
impl KeyedTrunk<Vec<u8>> for DataLakeTrunk {
...
impl TombstoneProvider<Vec<u8>> for DataLakeTrunk {
...
impl CapabilityAdvertiser for DataLakeTrunk {
...
impl TtlProvider<Vec<u8>> for DataLakeTrunk {
...
impl HistoryProvider<Vec<u8>> for DataLakeTrunk {
...
impl TtlCleaner<Vec<u8>> for DataLakeTrunk {
