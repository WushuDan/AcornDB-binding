...
impl KeyedTrunk<Vec<u8>> for S3Trunk {
...
impl TombstoneProvider<Vec<u8>> for S3Trunk {
...
impl CapabilityAdvertiser for S3Trunk {
...
impl TtlProvider<Vec<u8>> for S3Trunk {
...
impl HistoryProvider<Vec<u8>> for S3Trunk {
...
impl TtlCleaner<Vec<u8>> for S3Trunk {
